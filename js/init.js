var ip = 'http://store.api.smdouyou.com';
...
function openWindow(url,id,options){
	var data = {
		url : url,
		id : id,
		show : {
...
function getUrl(url,options){
	var u = ip + '/index.php/Api/' + url + '.html';
	if(options != undefined) u += '?' + options;
	return u;
}
